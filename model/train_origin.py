...
def main():
    ...
    opt = vars(args)
    #logger.info(opt) # TODO COMMENTED
    ...
    # ##
    training_step = 0
    cur_eval_step = 1 # TODO: FIXED it was 1 fixed to 0 UNderstand it
    ...
    if args.if_train:
        ...
        logger.info('Loading training data from '+ os.path.join(args.data_dir, args.train_data) )# TODO: + os.path.join(args.data_dir, args.train_data ADDED
        ...
        for epoch in tqdm(range(0, 10)):# #TODO args.epoches
            ...
            for i, batch in enumerate(tqdm(train_data)):
                ...
                if (training_step) == cur_eval_step:  # TODO: need to understand it
                    ...
                    print("full_path:  ", full_path) # TODO ADDED
                    print("pred_output:  ", pred_output) # TODO ADDED
                    print("full_output:  ", full_output) # TODO ADDED
                    print("curve_file: ", curve_file) # TODO ADDED
                    ...
                    print("check time",str((datetime.now() - checkstart) /60), " minutes")  # TODO ADDED

                    dev_loss = eval_test_loss(model, dev_data) # TODO: the problem is here
                    dev_loss = dev_loss.data.cpu().numpy()
                    print("eval_test_loss done ") # TODO ADDED
                    print("eval_test_loss done") # TODO ADDED
            ...
            if epoch%9 == 0:
                ...
                model_file = os.path.join(model_dir, 'checkpoint_epoch_{0}_{1}_{2:.5f}.pt'
                                          .format(epoch, args.learning_rate,np.exp(dev_loss)))
                # args.resume = model_file  # TODO ADDED
                model.save(model_file, epoch)
