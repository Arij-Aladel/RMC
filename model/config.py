...
def model_config(parser):
    ...
    parser.add_argument('--max_len', type=int, default=30)  # to truncate the query length max_len 	Yes, but it was not passed to filter the query during data processing that is why query length vary from 1 to 101
...
def data_config(parser):
    ...
    parser.add_argument('--meta', default='data/reddit_meta.pick', help='path to preprocessed meta file.') #TODO:default='reddit_meta.pick'
    ...
    parser.add_argument('--glove', default='./data_processing/glove.840B.300d.txt',  # TODO: fixed glove.840B.300d.txt' was not downloaded I downloaded it, data_processing/glove.840B.300d.txt' wa thwe path
...
def train_config(parser):
    ...
    parser.add_argument('--max_query', type=int, default=27)  # TODO:ADDED
    ...
    parser.add_argument('--model_type', type=str, default='san', help='[san|seq2seq|memnet|BERT]')
