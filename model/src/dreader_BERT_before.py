...
class DNetwork_BERT(nn.Module):
    ...
    def forward(self, batch, vocab):
        ...
        fix_d_len = self.opt['max_doc']  # fix lenght of document 
        ...
        for i in range(batch_size):
            ...
            if len(input_ids_q) > fix_q_len + 2: 
              ...
              mask_q = mask_q[:len(input_ids_q)-1] + [0]*(fix_q_len  - num_seg_q + 2) + [mask_q[-1]]
              input_ids_q = input_ids_q[:-1] + [0]*(fix_q_len  - num_seg_q +2) + [input_ids_q[-1]]
