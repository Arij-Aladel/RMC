#
# created by "Arij Al Adel" (Arij.Adel@gmail.com) at 1/30/21
#
...
def main():
    ...
    # model arguments
    check_dir = "checkpoints_tuner_with_generator_full"
    ...
    logger = TensorBoardLogger(
        save_dir=os.getcwd(),
        version=1,
        name='tuner_with_generator_log_full'
    )
    ...
    module_dict = dict(
        ...
        # val_batch_size=8,
        # test_batch_size=8,
        data_dir = "./data/processed/full/", # path for data files
        train_tsv = 'train2_cleaned.tsv',
        val_tsv = 'dev2_cleaned.tsv',
        test_tsv = 'test2.tsv',
        dev_full = 'dev_cleaned.full',
        test_full = 'test.full',
        train_batch_size=32,
        val_batch_size=32,
        test_batch_size=32,
