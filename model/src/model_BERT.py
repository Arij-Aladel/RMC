...
class DocReaderModel(object):
    ...
    def update(self, batch, smooth=-1, rep_train=0.5):
        ...
        for word in torch.split(doc_ans_emb, 1)[:-1]:
            ...
            # print('word.shape: ', word.shape) # (32, 768)
            # print('hidden.shape: ', hidden.shape) # (32, 512)
            # print('doc_mem.shape: ', doc_mem.shape) # (32, 768)
            # print('doc_mem.shape: ', doc_mask.shape) # (32, 768)  
            # return          
    ...
    def eval_test_loss(self, batch):  # TODO the issue is here
