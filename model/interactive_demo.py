...
class InteractiveModel:
	def __init__(self, args):
		...
		self.state_dict = th.load("/content/drive/MyDrive/converse_reading_cmr/model/checkpoint/san/checkpoint_epoch_1_0.0005_1097.80090.pt")["state_dict"]
